//FirewallPolicyTableUtilities.js
import { AiFillCheckCircle, AiOutlineStop } from 'react-icons/ai';
import { rowData as initialRowData } from "./FirewallPolicyData";
import React, { useState  } from "react";

export const [selectedCells, setSelectedCells] = useState([]);
export const [selectedRows, setSelectedRows] = useState([]);
export const [contextMenu, setContextMenu] = useState(null);
export const [rowData, setRowData] = useState(initialRowData);
export const [selectedMultiCellClick, setselectedMultiCellClick] = useState([]);
export const [sortConfig, setSortConfig] = useState({ key: null, direction: 'default' });

export const handleRowContextMenu = (event, rowId) => {
...
export const handleCellClick = (rowId, cellIndex) => {
  if (
...
export const handleCellContextMenu = (event, rowId, cellIndex) => {
...
export const handleRowCheckboxChange = (rowId) => {
...
export const handleMultiCellClick = (rowId, cellIndex, MultiCellIndex) => {
...
export const handleMultiCellContextMenu = (event, rowId, cellIndex, MultiCellIndex, cellDataLength) => {
...
export const renderHeader = (key, label) => (
  <th
